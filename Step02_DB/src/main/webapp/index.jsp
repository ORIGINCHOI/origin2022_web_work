	...
	<div class="container">
		...
		<div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="true">
		  ...
		  <div class="carousel-inner">
		    ...
		    <div class="carousel-item">
		      <img src="https://cdn.pixabay.com/photo/2012/08/06/00/53/bridge-53769_960_720.jpg" class="d-block w-100" alt="...">
		    </div>
		  </div>
            ...
            <div class="col-3">
                <div class="card">
                    <img src="https://cdn.pixabay.com/photo/2022/11/02/10/46/ice-rink-7564565_960_720.jpg" class="card-img-top"
                        alt="...">
                    <div class="card-body">
                        <h5 class="card-title">우리의 회원들</h5>
                        <p class="card-text">
                        	에이콘 회원님들^^
                        </p>
                        <a href="${pageContext.request.contextPath }/member/list.jsp" class="btn btn-primary">회원 목록 보기</a>
                    </div>
                </div>
            </div>
            <div class="col-3">
                <div class="card">
                    <img src="https://cdn.pixabay.com/photo/2015/04/22/11/21/to-do-734587_960_720.jpg" class="card-img-top"
                        alt="...">
                    <div class="card-body">
                        <h5 class="card-title">할일들</h5>
                        <p class="card-text">할일을 다 마쳐야 기분이 좋아요~</p>
                        <a href="${pageContext.request.contextPath }/todo/list.jsp" class="btn btn-primary">할일 목록 보기</a>
                    </div>
                </div>
            </div>
         </div>
